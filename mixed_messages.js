...
//Number -> Number
//Call LunarDate from LunarDate Object, Number (year, month, day) -> String
//Call LunarYear, save to variable (myLunarYear), Output: Number
//myLunarYear is the parameter needed in myAnimal
...
//testing
console.log(lunarCovert(1997, 2, 6)); //expected 1996, console: 1996
console.log(lunarCovert(1997, 2, 7)); //expected 1997, console: 1997
...
console.log(myAnimal(lunarCovert(1997, 2, 6))); //Console: Rat
console.log(myAnimal(lunarCovert(1997, 2, 7))); //Console: Ox
